...
const RegisterForm = props => {
  ...
  return <div className="form registerForm">
    ...
    <form className="form" onSubmit={handleSubmit(onSubmit)}>
      <div className="field">
        <input type="text" placeholder="Nombre" name="firstName" ref={register({required: true, maxLength: 100})} />
        {errors.firstName && <div className="error">Nombre es requerido</div>}
      </div>
      <div className="field">
        <input type="text" placeholder="Apellido" name="lastName" ref={register({required: true, maxLength: 100})} />
